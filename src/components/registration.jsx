...
function Registration() {
  ...
  return (
    <div className="jonsetu-wrapper">
      {/* Header */}
      <header className="jonsetu-header">
        <div className="header-inner container-fluid px-4 py-3 d-flex align-items-center justify-content-between">
          <div className="brand d-flex align-items-center gap-2">
            <span className="brand-name">জনসেতু</span>
          </div>
        </div>
      </header>

      {/* Main Content */}
      <main className="jonsetu-main d-flex align-items-center justify-content-center">
        <div className="registration-card">
          ...
          <div className="card-body-inner">
            <div className="card-title-section text-center mb-4">
              ...
              <h2 className="reg-title">রেজিস্ট্রেশন</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="form-group-custom mb-4">
                <label className="form-label-custom">
                  <span className="label-icon">🖼️</span> আপনার এনআইডির ছবি
                  সংযুক্ত করুন
                </label>
      ...
      {/* Footer */}
      <footer className="jonsetu-footer">
        <div className="footer-inner container-fluid px-4 py-4">
          <div className="row align-items-center">
            <div className="col-md-4 text-center text-md-start mb-3 mb-md-0">
              <span className="footer-brand">জনসেতু</span>
              <p className="footer-tagline mb-0">নাগরিক সেবার ডিজিটাল সেতু</p>
            </div>
            <div className="col-md-4 text-center mb-3 mb-md-0"></div>
            <div className="col-md-4 text-center text-md-end">
              <p className="footer-copy mb-0">
                © ২০২৫ জনসেতু। সর্বস্বত্ব সংরক্ষিত।
              </p>
            </div>
          </div>
        </div>
